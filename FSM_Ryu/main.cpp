...
bool external_input(queue<ryu_inputs>& inputs)
{
...
void internal_input(queue<ryu_inputs>& inputs)
{
	if(jump_timer > 0)
	{
...
ryu_states process_fsm(queue<ryu_inputs>& inputs)
{
...
int main(int argc, char** argv)
{
	...
	std::queue<ryu_inputs> inputs;
	ryu_states current_state = ST_UNKNOWN;
	printf("Listening for Arrow keys + SPACE for punch:\n");
